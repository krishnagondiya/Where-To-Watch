<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MovieDetails1.aspx.cs" Inherits="Where_To_Watch.MovieDetails1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="navbar">
            <a href="AdminDashboard.aspx">Back to Dashboard</a>
        </div>
        ...
        <div class="container">
            ...
            <div class="details">
                ...
                <a href="AdminDashboard.aspx" class="back-btn">Go Back</a>
            </div>
        </div>
    </form>
</body>
