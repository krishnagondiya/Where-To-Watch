<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMovie.aspx.cs" Inherits="Where_To_Watch.UpdateMovie" %>
...
<body>
    <a href="AdminDashboard.aspx" class="btn-home">Cancel</a>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="btn-container">
                <asp:Button ID="btnUpdateMovie" runat="server" Text="Update Movie" CssClass="btn btn-update" OnClick="btnUpdateMovie_Click" />
            </div>
        </div>
    </form>
</body>
